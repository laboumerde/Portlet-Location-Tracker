...
<select name="portletId" id="portletId">
			...
			<option value="">Select</option>
			 <c:forEach var="portlet" items="${portletList}">
			   ...
			   <%
			   String portletTitleAndId = PortalUtil.getPortletTitle((Portlet)pageContext.getAttribute("portlet"), application, locale); 
			   portletTitleAndId = portletTitleAndId + " (" + ((Portlet)pageContext.getAttribute("portlet")).getPortletId() + ")";
			   %>
			   <%=portletTitleAndId %></option>
